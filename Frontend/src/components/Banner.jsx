                    ...
                    <div className="row">
                        <div className="col-lg-6 mx-auto">
                            <div className="banner-area text-center pt-4 pb-4">
                                <p>إبحث عن عقارات للبيع و للايجار بالتقسيط او كاش في مصر </p>
                                <h2 className="mt-2 mb-4 banner-title"><strong> تحب تسكن فين؟</strong> </h2>
                                <div className="search-area">
                                    <input value={word} onChange={(e) => findSearch(e)} type="text" className="inp-search" placeholder="بحث" />
                                    <button className="btn-search m-2">ابحث الان</button>
                                </div>
                                {findResult()}
                            </div>
                        </div>
